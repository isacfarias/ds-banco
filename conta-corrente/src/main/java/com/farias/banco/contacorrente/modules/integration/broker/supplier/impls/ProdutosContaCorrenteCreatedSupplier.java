package com.farias.banco.contacorrente.modules.integration.broker.supplier.impls;

import com.farias.banco.contacorrente.constants.BrokerConstants;
...
@Slf4j
public class ProdutosContaCorrenteCreatedSupplier implements Supplier<Message<String>> {
